...
com! -nargs=0 ShowMarksHideAll   :call <sid>ShowMarksHideAll()
...
if !hasmapto( '<Plug>ShowmarksHideAll'         ) | map <silent> <unique> <leader>mh :ShowMarksHideAll<cr>| endif
...
if g:showmarks_enable == 1
	aug ShowMarks
		...
		autocmd VimEnter * call s:ShowMarks()
	aug END
endif
